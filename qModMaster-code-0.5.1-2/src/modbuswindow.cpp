    ...
    ui(new Ui::ModbusWindow)
{
    ...
    ui->tabWidget->setTabText(0,"零点标定");
    ui->tabWidget->setTabText(1,"累积量设置");
    ui->tabWidget->setTabText(2,"主要变量监测");

    ui->tabWidget->addTab(new QWidget(this),"参考变量监测");
    ui->tabWidget->addTab(new QWidget(this),"设备状态监测");
    ui->tabWidget->addTab(new QWidget(this),"设备操作");
